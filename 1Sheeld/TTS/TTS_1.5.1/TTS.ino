...
void loop()
{
	...
	if (VoiceRecognition.isNewCommandReceived()) {
		...
		else if (!strcmp(dhtTerminalOnCommand, VoiceRecognition.getLastCommand()) || !strcmp(dhtTerminalOn2Command, VoiceRecognition.getLastCommand())) {				// DHT write in terminal ON
			TextToSpeech.say(F("Please tell me the pin number"));
			delay(3000);
		...
		else if (!strcmp(dhtTerminalOffCommand, VoiceRecognition.getLastCommand()) || !strcmp(dhtTerminalOff2Command, VoiceRecognition.getLastCommand())) {				// DHT write in terminal OFF
			DHTTerminal = 0;
...
{		
	...
	Terminal.println("Temperature: " + tStr + "C and humidity: " + hStr + "%");
	delay(500);
}
